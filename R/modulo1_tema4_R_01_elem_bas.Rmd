...
Guarda el documento generado automaticamente con el nombre `11_actividad.Rmd`. Ahora genera el documento apretando el botón **Knit**.
...
- `type`: 'p' indica puntos, 'l' lineas. Ver `?plot`. 
- `col`: 'red' cambia la linea a rojo. Ver `?colors`
