...
\<imagen1\>Imagen 1: Entorno RStudio (Fuente: Elaboración propia). (www/rstudio.png){width=450px}
...
\<imagen1\>Imagen 2: Menú de nuevo RMarkdown (Fuente: Elaboración propia). (www/rmarkdown1.png){width=200px}
