...
También es común el uso de `fileEncoding="Latin1"` cuando el fichero se ha creado con Windows y utiliza carácteres especiales de texto (tildes, ...).
...
Vemos que ID=1 ahora esta presente y ID=4 ha quedado descartado. También que ID=3 sólo aparece una vez. Este comportamiento en SQL, es conocido como LEFT JOIN .
...
```{r, fig.cap='Contienentes (Fuente: Elaboracion propia, datos de Gapminder)'}
