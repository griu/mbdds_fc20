...
## 1.5. Colecciones de objetos

<br>

### 1.5.1. Definición de los objetos
...
\<imagen1\>(www/dataframe.png){width=125px}
...
\<imagen1\>(www/headpaises07.png){width=450px}
...
\<imagen1\>(www/headpaises070.png){width=125px}
...
\<imagen1\>(www/headpaises071.png){width=450px}
...
\<imagen1\>(www/headpaises072.png){width=350px}
...
\<imagen1\>(www/headpaises073.png){width=200px}
...
\<imagen1\>(www/headpaises074.png){width=200px}
...
![](www/headpaises075.png){width=200px}

\<imagen1\>(www/headpaises075.png){width=200px}
...
![](www/logicos1.png){width=350px}

\<imagen1\>Operadores lógicos: (fuente: elaboración propia) (www/logicos1.png){width=350px}
...
![](www/logicos2.png){width=450px}

\<imagen1\>Operaciones booleanas: (fuente: elaboración propia) (www/logicos2.png){width=450px}
...
\<imagen1\>(www/logicos3.png){width=450px}

<br>

### 1.5.3. Modificación de valores
...
\<imagen1\>(www/headpaises076.png){width=500px}
...
\<imagen1\>(www/paisesNA1.png){width=550px}
...
\<imagen1\>(www/paisesNA2.png){width=450px}

<br>

##### FILTROS EN COLUMNAS CON VALORES FALTANTES

<br>

La presencia de NA en una columna dificulta la definición de condiciones lógicas.  Por ejemplo, si seleccionamos países con PIB per cápita inferior a 500 dólares se obtiene el siguiente resultado incorrecto:
...
kable(paises07NA[paises07NA$pib_per_capita<500,], "html", booktabs=TRUE,align="r", row.names = TRUE,) %>%
  ...
  save_kable("www/paisesNA21.png")
options(knitr.kable.NA = '')
```

![](www/paisesNA21.png){width=450px}

\<imagen1\>(www/paisesNA21.png){width=450px}
...
\<imagen1\>(www/paisesNA3.png){width=450px}
...
Mejora de nuevo el informe con la actividad guiada 1.4.
