...
En los siguientes puntos se presenta como vectorizar funciones sobre objetos R (vectores, listas, dataframes...).  
...
La expresión `if()` evalua un único valor lógico. Es habitual el uso de `any()` y `all()` para tratar condiciones sobre vectores.
...
La función `ifelse()` se peude utilizar sobre vectores y devuelve un vector.
