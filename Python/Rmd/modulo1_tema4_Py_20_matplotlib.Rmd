...
__[Abre en Colab](https://colab.research.google.com/github/griu/mbdds_fc20/blob/master/Python/modulo1_tema4_Py_20_matplotlib.ipynb)__
...
El primer paso consiste en cargar los datos de las especies y extraer las columnas.
...
### 2.4.1. Conceptos básicos en Matplotlib
...
Ahora un ejemplo donde se modifica la paleta de colores `viridis` y también el tamaño de los puntos.
...
En el resto del cuadrante, se muestra el gráfico de dispersión entre dos columnas. También se añaden los colores con las especies.  
